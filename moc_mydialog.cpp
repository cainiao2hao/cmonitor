...
**
** Created: Wed May 22 20:04:13 2013
...
static const char qt_meta_stringdata_MyDialog[] = {
    "MyDialog\0\0updateProcess()\0updateTab()\0"
    "x\0mySort(int)\0pos\0rightClick(QPoint)\0"
    "doKill()\0"
};
...
void MyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateProcess(); break;
        case 1: _t->updateTab(); break;
        case 2: _t->mySort((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->rightClick((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 4: _t->doKill(); break;
        default: ;
        }
    }
}
